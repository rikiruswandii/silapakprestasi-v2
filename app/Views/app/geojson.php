...
<div class="col-auto ms-auto d-print-none">
    <div class="btn-list">
        ...
        <a href="javascript:void(0)" class="add-button btn btn-primary d-sm-none btn-icon" data-bs-toggle="modal" data-bs-backdrop="static" data-bs-target="#modal-form" aria-label="Unggah Geojson">
            <?= tabler_icon('upload') ?>
        </a>
    </div>
</div>
...
<div class="modal modal-blur fade" id="modal-form" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-md modal-dialog-centered" role="document">
        ...
        <div class="modal-header">
            <h5 class="modal-title">Unggah Geojson</h5>
        ...
        <div class="modal-body">
            ...
            <div class="mb-3">
                ...
                <select name="type" class="form-control select2 tags" data-tags="true">
