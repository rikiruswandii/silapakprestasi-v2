...
$(document).ready(function(){
        $('.dropdown-item[data-switch-lang]').click(function(){
            var langCode = $(this).data('switch-lang');
            $('.language-select a[data-active-lang]').attr('data-active-lang', langCode);
            $('.language-select a.dropdown-toggle').text(langCode.toUpperCase());
        });
    });
