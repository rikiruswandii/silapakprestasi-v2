            ...
            <div class="col-md-7 col-lg-6 col-xl-5 mx-auto">
                ...
                <nav class="d-inline-block" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Investasi</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Promosi Investasi</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="row gx-lg-8 gx-xl-12 gy-4 gy-lg-0">
            <div class="col-lg-8 align-self-center">
                <div class="blog-filter filter">
                    <ul>
                        <?php foreach (sectors(null, false) as $sector) : ?>
                            <li><a href="<?= base_url('investments/' . $sector->slug) ?>"><?= $sector->name ?></a></li>
                        <?php endforeach ?>
                    </ul>
                </div>
            </div>
            <aside class="col-lg-4 sidebar">
                <form class="search-form" method="GET">
                    <div class="form-label-group mb-0">
                        <input name="s" id="search-form" type="text" class="form-control" placeholder="Cari promosi inovasi ..." value="<?= $keyword ?>">
                        <label for="search-form">Cari promosi inovasi ...</label>
                    </div>
                </form>
            </aside>
        </div>
                                        ...
                                        <div class="card-body">
                                            <div class="post-header">
                                                <div class="post-category text-line">
                                                    <a href="<?= base_url('investments/' . $item->slugsector) ?>" class="hover" rel="category"><?= $item->sector ?? "Promosi Investasi" ?></a>
                                                </div>
