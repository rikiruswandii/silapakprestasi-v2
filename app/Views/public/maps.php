        ...
        <div id="sideRight" class="sidebarRight" style="right: 0px; background-color:white;">
            ...
            <div class="coordinateHeader">
                <div class="icon-container">
                    ...
                    <span class="text-light p-1">-6.5569400, 107.4433300</span>
                </div>
            </div>
    ...
    var initMap = function() {
        ...
        function generatePopupContent(feature) {
            ...
            if (feature.properties.NAMOBJ) {
                popupContent += '<p style="font-size:12px"><span style="font-size:14px; font-weight:bold;">Nama Pelaku Usaha : </span></br>' + feature.properties.NAMOBJ + '</p>';
                popupContent += '<p style="font-size:12px"><span style="font-size:14px; font-weight:bold;">Alamat Usaha : </span></br>' + feature.properties.ALMTNH + '</p>';
                popupContent += '<p style="font-size:12px"><span style="font-size:14px; font-weight:bold;">Jenis Usaha : </span></br>' + feature.properties.JNSUSH + '</p>';
                popupContent += '<p style="font-size:12px"><span style="font-size:14px; font-weight:bold;">Luas Tanah : </span></br>' + feature.properties.SHAPE_Area.toFixed(2); + '</p>';
            }
