...
if (count($sliders) > 0) {
    ...
    foreach ($sliders as $slider) {
        echo '<div class="swiper-slide active" style="background-image: url(' . base_url('uploads/thumbnails/' . $slider->images) . ');"></div>';
    }
    echo '</div>';
    ...
    <div class="container pt-14 pt-md-16">
        <div class="row text-center">
            <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-2">
                ...
                <h3 class="display-4 mb-4">Layanan yang kami paparkan dirancang khusus untuk memenuhi kebutuhan anda.</h3>
            </div>
        </div>
    ...
    <div class="container py-16 py-md-18">
        <div class="row gx-lg-8 gx-xl-12 gy-10 mb-8 align-items-center">
            <div class="col-lg-6 order-lg-2">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/w3Jg2GCSQWg?si=LlweOHSsn3qEIH9G" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>

            <div class="col-lg-6">
                <h3 class="display-4 mb-5">Investasi Fashion, Kuliner <br> dan Industri di <br> Purwakarta</h3>
                <p class="mb-7 text-dark" style="font-size:medium;">Purwakarta, dikenal sebagai pusat perkembangan fashion dan kuliner di Jawa Barat. Kabupaten ini dipenuhi oleh masyarakat yang dinamis, kreatif, dan inovatif yang gemar akan desain mode terkini dan hidangan lezat. Meningkatkan bisnis atau fashion kuliner di Kabupaten Purwakarta tentu akan menantang, namun juga akan penuh dengan kesenangan dan kenikmatan. Selain itu, Purwakarta juga menjadi destinasi favorit bagi banyak pengunjung domestik karena iklimnya yang nyaman dan budayanya yang menarik. Sungguh sebuah kabupaten yang unik di Indonesia. <b>#InvestasiPurwakarta #PeluangTakTerbatas</b> </p>
