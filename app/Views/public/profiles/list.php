        ...
        <div class="row gx-lg-8 gx-xl-12 gy-4 gy-lg-0">
            <div class="col-lg-8 align-self-center">
                <div class="blog-filter filter">
                    <p>Pelayanan:</p>
                    <ul>
                        <li><a class="active" href="javascript:void(0)">Profil Instansi</a></li>
                        <li><a href="<?= base_url('innovations') ?>">Promosi Inovasi</a></li>
                    </ul>
                </div>
            </div>
                                ...
                                <article class="item post col-md-4">
                                    <div class="card">
                                        <figure class="card-img-top overlay overlay1 hover-scale">
                                            <a href="<?= base_url('profile/' . $item->slug) ?>">
                                        ...
                                        <div class="card-body">
                                            <div class="post-header">
                                                ...
                                                <h2 class="post-title h3 mt-1 mb-3">
                                                    <a class="link-dark" href="<?= base_url('profile/' . $item->slug) ?>">
                                                        <?= $item->title ?>
                                                    </a>
                                                </h2>
                                            </div>
